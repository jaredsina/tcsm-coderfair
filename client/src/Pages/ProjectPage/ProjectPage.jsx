      ...
      <Flex mih={50} gap="md" direction="row" justify="center" wrap="wrap">
        {shownProjects?.map((project, index) => (
          <div className="ProjectCard" key={index}>
            <ProjectCard classname={''} project_id={project._id || ""} title={project.name} language={project.coding_language ? project.coding_language : "Other"} description={project.description} image={project.project_image ? project.project_image : "https://raw.githubusercontent.com/mantinedev/mantine/master/.demo/images/bg-8.png"}/>
          </div>
        ))}
      </Flex>
    </main>
